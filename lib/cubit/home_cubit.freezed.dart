...
abstract class _errors implements HomeState {
...
abstract class _$$sucessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({HomeRespone response});
}

/// @nodoc
class __$$sucessImplCopyWithImpl<$Res>
    extends _$HomeStateCopyWithImpl<$Res, _$sucessImpl>
...
class _$sucessImpl implements _sucess {
  const _$sucessImpl(this.response);

  @override
  final HomeRespone response;

  @override
  String toString() {
    return 'HomeState.sucess(response: $response)';
  }
...
abstract class _sucess implements HomeState {
  const factory _sucess(final HomeRespone response) = _$sucessImpl;
